...
class UploadModuleWizard(models.Model):
     ...
     ## datas_fname = fields.Char(string='Nombre', related='app.db_datas')
     datas_fname = fields.Char(string='Nombre')
     ...
     updated = fields.Char(string='Updated')
     added = fields.Char(string='added')

     ### @api.multi
     def create_button(self):
       ## view_id = self.env['ir.attachment']
