odoo.define('gtica_floating_social_share_buttons.social_share', function (require) {
'use strict';
...
registry.websiteSharePopUp = publicWidget.Widget.extend({
    selector: '#wrapwrap',
    xmlDependencies: ['/gtica_floating_social_share_buttons/static/src/xml/website_share_buttons.xml'],
    events: {
    ...
    _overButtons: function (social) {
       ...
       $('a[data-social=' + social + ']').popover({
            content: qweb.render('gtica_floating_social_share_buttons.social_hover', {name_media: social}),
            placement: 'bottom',
            container: 'body',
            html: true,
            trigger: 'manual',
    ...
    _renderPopUpSocial: function (sociaList) {
        ...
        $('body').append(qweb.render('gtica_floating_social_share_buttons.all', {medias: socialList}));
