odoo.define('rasa_bot.systray.MessagingMenu', function (require) {
"use strict";
...
return MessagingMenu.include({
    ...
    _computeCounter: function () {
        ...
        if (this.call('rasabot_service', 'hasRequest')) {
            counter++;
        }
        return counter;
    },
    ...
    _getPreviews: function () {
        var rasabotPreviews = this.call('rasabot_service', 'getPreviews', this._filter);
        var rasabotPreviews = []
        return this._super.apply(this, arguments).then(function (previews) {
            return _.union(rasabotPreviews, previews);
        });
    },
    /**
    ...
    _handleResponseNotificationPermission: function (value) {
        this.call('rasabot_service', 'removeRequest');
        if (value !== 'granted') {
